    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview" id="mainCourseNav">
        ...
        <ul class="treeview-menu">
          ...
          <li id="manageCourseSujectNav"><a href="<?php echo base_url('course/subjects') ?>"><i class="fa fa-circle-o"></i> Manage Subjects</a></li>
          <?php endif; ?>
        </ul>
      </li>
      <?php endif; ?>
      ...
      <li><a href="<?php echo base_url('assignment/') ?>"><i class="fa fa-book"></i> <span>Assingemnt</span></a></li>
      <?php endif; ?>
      <?php if(in_array('createTimeTable', $user_permission) || in_array('viewTimeTable', $user_permission) ): ?>
      <li><a href="<?php echo base_url('TimeTable/') ?>"><i class="ion ion-clock"></i> <span>Time Table</span></a></li>
      <?php endif; ?>
      <?php if( in_array('viewStudents', $user_permission) ): ?>
      <li><a href="<?php echo base_url('users/students') ?>"><i class="fa fa-users"></i> <span>Students</span></a></li>
      <?php endif; ?>
